...
#ifndef _Included_com_cxp_nativelibffmpeg_YuvUtil
#define _Included_com_cxp_nativelibffmpeg_YuvUtil
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_cxp_nativelibffmpeg_YuvUtil
 * Method:    NV21ToI420
 * Signature: ([B[BII)I
 */
