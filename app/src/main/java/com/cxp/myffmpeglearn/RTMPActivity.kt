...
import com.hapi.rtmpliving.RTMPPusherContext
...
class RTMPActivity : AppCompatActivity() {
    ...
    var url: String? ="rtmp://pili-publish.qnsdk.com/sdk-live/manjiale"
    private val mediaRecorderContext by lazy {
        val context = RTMPPusherContext()
    ...
    private fun startCamera() {
        ...
        mediaRecorderContext.native_startPush(
